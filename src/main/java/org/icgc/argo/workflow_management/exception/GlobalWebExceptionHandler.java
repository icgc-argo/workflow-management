...
public class GlobalWebExceptionHandler { // implements WebExceptionHandler{
  ...
  private static HttpStatus processResponseStatus(Throwable t, long timestamp) {
    ...
    val responseResult =
        Optional.ofNullable(findMergedAnnotation(t.getClass(), ResponseStatus.class));
  ...
  private static Mono<Void> processResponse(
      ServerHttpResponse serverHttpResponse, String responseBody, int httpStatusCode) {
  ...
  private static ErrorResponse getErrorResponseRaw(
      Throwable ex, HttpStatus status, long timestamp) {
