...
public class VolumeMountsTest {
  ...
  public void defaultConfigTest() {
    ...
    assertEquals(List.of("pv-claim:/some/dir"), VolumeMounts.extract(mappings, "/some/dir/with/sub/dir"));
  }

  @Test
  public void multiDirTest() {
    val mappings = List.of("pv-claim-one:/test-dir-1/,/dir-one/", "pv-claim-two:/test-dir-2/,/dir-two/", "pv-claim-three:/test-dir-3/,/dir-three/");

    assertEquals(
        List.of("pv-claim-one:/test-dir-1/"),
        VolumeMounts.extract(mappings, "/dir-one/test/dir"));

    assertEquals(
            List.of("pv-claim-two:/test-dir-2/"),
            VolumeMounts.extract(mappings, "/dir-two/test/dir"));
  ...
  public void multiMatchTest() {
    val mappings = List.of("pv-claim-one:/test-dir-1/,/vol-dir/", "pv-claim-one:/test-dir-2/,/vol-dir/", "pv-claim-one:/test-dir-3/,/vol-dir/");

    assertEquals(List.of("pv-claim-one:/test-dir-1/", "pv-claim-one:/test-dir-2/", "pv-claim-one:/test-dir-3/"), VolumeMounts.extract(mappings, "/vol-dir/sub/dir"));
  }
  ...
  public void testExtractFromPropertiesWhenPresent() {
    ...
    assertEquals(List.of("pv-claim:/some/dir"), VolumeMounts.extract(k8sProperties, "/some/dir/with/sub/dir"));
  }
